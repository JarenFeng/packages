...
public class Messages {
  ...
  public static final class CreateMessage {
    ...
    private @Nullable Long networkHandle;

    public @Nullable Long getNetworkHandle() {
      return networkHandle;
    }

    public void setNetworkHandle(@Nullable Long setterArg) {
      this.networkHandle = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(asset, that.asset) && Objects.equals(uri, that.uri) && Objects.equals(packageName, that.packageName) && Objects.equals(formatHint, that.formatHint) && httpHeaders.equals(that.httpHeaders) && Objects.equals(viewType, that.viewType) && Objects.equals(networkHandle, that.networkHandle);
    }

    @Override
    public int hashCode() {
      return Objects.hash(asset, uri, packageName, formatHint, httpHeaders, viewType, networkHandle);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setNetworkHandle(@Nullable Long setterArg) {
        this.networkHandle = setterArg;
        return this;
      }
      ...
      public @NonNull CreateMessage build() {
        ...
        pigeonReturn.setNetworkHandle(networkHandle);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(networkHandle);
      return toListResult;
    }
    ...
    static @NonNull CreateMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object networkHandle = pigeonVar_list.get(6);
      pigeonResult.setNetworkHandle((Long) networkHandle);
      return pigeonResult;
    }
  }
